...
while action.lower() != "no": #takes into consideration uppercases, saw it while researching
   name = input("Enter an employee name: (type no if u wanna stop)")
   if name.lower() == "no":  #same as before for uppercase 
      break
